...
namespace Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Models.EccpDictMaintenanceItems
{
    ...
    /// </summary>
    public class EccpDictMaintenanceItemPrintViewModel
    {
        /// <summary>
        /// Gets or sets the get eccp dict maintenance item print for views.
        /// </summary>
        public List<GetEccpDictMaintenanceItemPrintForView> GetEccpDictMaintenanceItemPrintForViews { get; set; }
    }
}