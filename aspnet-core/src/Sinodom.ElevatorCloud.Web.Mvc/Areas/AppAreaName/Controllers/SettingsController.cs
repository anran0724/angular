...
using Sinodom.ElevatorCloud.Configuration.Tenants;
using Sinodom.ElevatorCloud.Timing;
using Sinodom.ElevatorCloud.Timing.Dto;
using Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Models.Settings;
...
namespace Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Controllers
{
    ...
    public class SettingsController : ElevatorCloudControllerBase
    {
