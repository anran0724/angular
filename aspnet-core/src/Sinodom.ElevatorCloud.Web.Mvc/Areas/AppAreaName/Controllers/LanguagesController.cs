...
using Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Models.Languages;
...
namespace Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : ElevatorCloudControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = ElevatorCloudConsts.LocalizationSourceName;
            }
