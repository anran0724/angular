...
using Sinodom.ElevatorCloud.Authorization.Users.Profile;
using Sinodom.ElevatorCloud.Configuration;
using Sinodom.ElevatorCloud.Timing;
using Sinodom.ElevatorCloud.Timing.Dto;
using Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Models.Profile;
...
namespace Sinodom.ElevatorCloud.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class ProfileController : ElevatorCloudControllerBase
    {
