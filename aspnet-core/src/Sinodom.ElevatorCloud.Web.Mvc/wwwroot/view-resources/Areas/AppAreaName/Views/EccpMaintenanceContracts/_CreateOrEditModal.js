(function ($) {
    app.modals.CreateOrEditEccpMaintenanceContractModal = function () {
        ...
        var _eCCPBaseMaintenanceCompanyLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/EccpMaintenanceContracts/ECCPBaseMaintenanceCompanyLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/EccpMaintenanceContracts/_ECCPBaseMaintenanceCompanyLookupTableModal.js',
        ...
        var _eccpBaseElevatorLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/EccpMaintenanceContracts/EccpBaseElevatorLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/EccpMaintenanceContracts/_EccpBaseElevatorLookupTableModal.js',
        ...
        this.save = function () {
            ...
            _eccpMaintenanceContractsService.createOrEdit(
                eccpMaintenanceContract
            ).done(function () {
                abp.notify.info(app.localize('SavedSuccessfully'));
                _modalManager.close();
                abp.event.trigger('app.createOrEditEccpMaintenanceContractModalSaved');
            }).always(function () {
