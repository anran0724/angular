(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'Sinodom.ElevatorCloud.Authorization.Roles.Role';
        ...
        $('#PermissionAssignmentButton').click(function () {
            _roleService.rolePermissionAssignment().done(function () {
