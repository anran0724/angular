(function ($) {
    ...
    app.modals.CreateOrEditEccpMaintenancePlanModal = function () {
        //$("#m_wizard").mWizard();
        ...
        $('#OpenEccpBaseElevatorsLookupTableButton').click(function () {
            ...
            _eccpBaseElevatorsLookupTableModal.open({ id: eccpMaintenancePlan.elevatorId, displayName: eccpMaintenancePlan.eccpBaseElevatorName, planGroupGuid: $('[name=planGroupGuid]').val(), elevatorIds: $('[name=elevatorIds]').val(), elevatorNames: $('[name=elevatorNames]').val() }, function (data) {
