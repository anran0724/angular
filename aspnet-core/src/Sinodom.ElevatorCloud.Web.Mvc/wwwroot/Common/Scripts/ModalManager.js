...
(function ($) {
    ...
    app.ModalManager = (function () {
        ...
        function _createContainer(modalId, modalWidth) {
            ...
            return $('<div id="' + _containerId + '"></div>')
                .append(
                    '<div id="' +
                    modalId +
                    '" class="modal fade" tabindex="-1" role="modal" aria-hidden="true">' +
                    '  <div class="modal-dialog modal-lg" ' +
                    (modalWidth ? 'style="max-width:' + modalWidth + '"' : '') +
                    '>' +
        ...
        return function (options) {
            ...
            var _modalWidth = options.modalWidth;
            ...
            function _initAndShowModal() {
                ...
                _$modal.on('hidden.bs.modal', function () {
                    ...
                    if ($("body").find("div[role='modal']").length > 0) {
            ...
            var _open = function (args, getResultCallback) {
                ...
                _createContainer(_modalId, _modalWidth)
                    .find('.modal-content')
