...
using Sinodom.ElevatorCloud.Web.Public.Startup;
using Sinodom.ElevatorCloud.Web.Session;

namespace Sinodom.ElevatorCloud.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ElevatorCloudViewComponent
    {
