...
using Sinodom.ElevatorCloud.Web.Authentication.TwoFactor;
using Sinodom.ElevatorCloud.Web.Chat.SignalR;
using Sinodom.ElevatorCloud.Web.Configuration;
...
namespace Sinodom.ElevatorCloud.Web
{
    ...
    public class ElevatorCloudWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ElevatorCloudWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ElevatorCloudApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ElevatorCloudWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(ElevatorCloudWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
