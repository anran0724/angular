...
namespace Sinodom.ElevatorCloud.Web.Url
{
    public abstract class WebUrlServiceBase
    {
        ...
        public string WebSiteRootAddressFormat => _appConfiguration[WebSiteRootAddressFormatKey] ?? "http://localhost:63114/";

        public string ServerRootAddressFormat => _appConfiguration[ServerRootAddressFormatKey] ?? "http://localhost:63114/";
