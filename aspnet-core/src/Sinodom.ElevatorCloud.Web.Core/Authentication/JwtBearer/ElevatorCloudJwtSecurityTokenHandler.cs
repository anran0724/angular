...
namespace Sinodom.ElevatorCloud.Web.Authentication.JwtBearer
{
    public class ElevatorCloudJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ElevatorCloudJwtSecurityTokenHandler()
        {
