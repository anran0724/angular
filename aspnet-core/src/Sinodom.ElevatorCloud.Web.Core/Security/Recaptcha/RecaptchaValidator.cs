...
namespace Sinodom.ElevatorCloud.Web.Security.Recaptcha
{
    public class RecaptchaValidator : ElevatorCloudServiceBase, IRecaptchaValidator, ITransientDependency
    {
