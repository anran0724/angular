...
using Sinodom.ElevatorCloud.Auditing.Exporting;
using Sinodom.ElevatorCloud.Authorization;
using Sinodom.ElevatorCloud.Authorization.Users;
using Sinodom.ElevatorCloud.Dto;
using EntityHistoryHelper = Sinodom.ElevatorCloud.EntityHistory.EntityHistoryHelper;

namespace Sinodom.ElevatorCloud.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ElevatorCloudAppServiceBase, IAuditLogAppService
    {
