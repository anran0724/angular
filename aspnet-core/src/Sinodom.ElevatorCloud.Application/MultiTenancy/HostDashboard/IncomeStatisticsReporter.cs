...
namespace Sinodom.ElevatorCloud.MultiTenancy.HostDashboard
{
    public class IncomeStatisticsService : ElevatorCloudDomainServiceBase, IIncomeStatisticsService
    {
