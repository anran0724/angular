...
namespace Sinodom.ElevatorCloud.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ElevatorCloudAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ElevatorCloudDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(ElevatorCloudConsts.ConnectionStringName).Value.ToString();
        }
