...
using Sinodom.ElevatorCloud.Authorization.Users.Profile.Cache;
using Sinodom.ElevatorCloud.Authorization.Users.Profile.Dto;
using Sinodom.ElevatorCloud.Dto;
using Sinodom.ElevatorCloud.Friendships;
using Sinodom.ElevatorCloud.Gdpr;
using Sinodom.ElevatorCloud.Identity;
using Sinodom.ElevatorCloud.Security;
using Sinodom.ElevatorCloud.Storage;
using Sinodom.ElevatorCloud.Timing;

namespace Sinodom.ElevatorCloud.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ElevatorCloudAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Sinodom.ElevatorCloud",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Sinodom.ElevatorCloud",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
