// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllECCPBaseMaintenanceCompaniesForExcelInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// The get all eccp base maintenance companies for excel input.
    /// </summary>
    public class GetAllECCPBaseMaintenanceCompaniesForExcelInput
    {
        /// <summary>
