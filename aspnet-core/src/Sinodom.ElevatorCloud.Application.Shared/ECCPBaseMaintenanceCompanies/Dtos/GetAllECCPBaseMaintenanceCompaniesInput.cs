// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllECCPBaseMaintenanceCompaniesInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sinodom.ElevatorCloud.ECCPBaseMaintenanceCompanies.Dtos
{
    ...
    /// <summary>
    /// The get all eccp base maintenance companies input.
    /// </summary>
    public class GetAllECCPBaseMaintenanceCompaniesInput : PagedAndSortedResultRequestDto
    {
        /// <summary>
