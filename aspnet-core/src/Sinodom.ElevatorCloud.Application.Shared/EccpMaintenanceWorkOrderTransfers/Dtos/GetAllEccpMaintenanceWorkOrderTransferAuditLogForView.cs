// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllEccpMaintenanceWorkOrderTransferAuditLogForView.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sinodom.ElevatorCloud.EccpMaintenanceWorkOrderTransfers.Dtos
{
    ...
    /// <summary>
    /// The get all eccp maintenance work order transfer audit log for view.
    /// </summary>
    public class GetAllEccpMaintenanceWorkOrderTransferAuditLogForView
    {
        /// <summary>
        ///     申请转接时间
        /// </summary>
