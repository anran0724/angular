// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetEccpMaintenanceWorkOrderTransfersForView.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sinodom.ElevatorCloud.EccpMaintenanceWorkOrderTransfers.Dtos
{
    ...
    /// <summary>
    /// The get eccp maintenance work order transfers for view.
    /// </summary>
    public class GetEccpMaintenanceWorkOrderTransfersForView
    {
        /// <summary>
        ///     申请转接时间
        /// </summary>
