// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllECCPBaseAnnualInspectionUnitsForExcelInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// The get all eccp base annual inspection units for excel input.
    /// </summary>
    public class GetAllECCPBaseAnnualInspectionUnitsForExcelInput
    {
        /// <summary>
