// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllEccpElevatorQrCodesInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sinodom.ElevatorCloud.EccpElevatorQrCodes.Dtos
{
    ...
    /// <summary>
    /// The get all eccp elevator qr codes input.
    /// </summary>
    public class GetAllEccpElevatorQrCodesInput : PagedAndSortedResultRequestDto
    {
        /// <summary>
