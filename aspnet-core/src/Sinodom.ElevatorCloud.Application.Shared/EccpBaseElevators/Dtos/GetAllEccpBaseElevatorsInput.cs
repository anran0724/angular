// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllEccpBaseElevatorsInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sinodom.ElevatorCloud.EccpBaseElevators.Dtos
{
    ...
    /// <summary>
    /// The get all eccp base elevators input.
    /// </summary>
    public class GetAllEccpBaseElevatorsInput : PagedAndSortedResultRequestDto
    {
        /// <summary>
