// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllECCPBaseProductionCompaniesForExcelInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// The get all eccp base production companies for excel input.
    /// </summary>
    public class GetAllECCPBaseProductionCompaniesForExcelInput
    {
        /// <summary>
