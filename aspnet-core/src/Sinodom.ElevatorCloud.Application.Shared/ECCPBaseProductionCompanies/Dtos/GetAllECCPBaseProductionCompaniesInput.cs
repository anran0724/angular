// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllECCPBaseProductionCompaniesInput.cs" company="Sinodom">
//   ElevatorTeam@2018
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sinodom.ElevatorCloud.ECCPBaseProductionCompanies.Dtos
{
    ...
    /// <summary>
    /// The get all eccp base production companies input.
    /// </summary>
    public class GetAllECCPBaseProductionCompaniesInput : PagedAndSortedResultRequestDto
    {
        /// <summary>
