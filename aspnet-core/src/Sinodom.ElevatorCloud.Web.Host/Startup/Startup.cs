...
using Sinodom.ElevatorCloud.Install;
...
namespace Sinodom.ElevatorCloud.Web.Startup
{
    public class Startup
    {
        ...
        public Startup(IHostingEnvironment env)
        {
            ...
            // EF Profiler ²é¿´¸ú×ÙEntity Framework SQL Óï¾ä
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<ElevatorCloudWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Sinodom.ElevatorCloud.Web.wwwroot.swagger.ui.index.html");
