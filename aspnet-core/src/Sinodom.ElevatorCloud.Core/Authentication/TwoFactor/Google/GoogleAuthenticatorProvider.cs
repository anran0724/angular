...
namespace Sinodom.ElevatorCloud.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ElevatorCloudServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Sinodom.ElevatorCloud", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
